<Box className="mb-0">
  <div className="d-flex">
    <div>
      <div className="col-xs-12 col-md-3 gkvlogo">
        <div className="widget dark mextra">
          <img
          ...
          <ul className=" me1 list-inline mt-5 text-center  d-flex flex-row">
            <li className="m-0 pl-10 pr-10">
              ...
              <a className="text-gray i3 " href="javascript:void(0)">
                www.gkv.ac.in
              </a>{" "}
            </li>
          </ul>
          <ul className="d-flex i3 list-unstyled styled-icons border-0 icon-sm icon-bordered icon-circled clearfix mt-10 text-center m-10 ">
            <li className="i1">
              <a
                className="i1"
            ...
            <li className="i1">
              <a
                className="i1"
                href="https://twitter.com/gkvsocial"
                target="_blank"
              >
            ...
            <li className="i1">
              <a
                className="i1   "
                href="https://www.instagram.com/gkv_hdr/"
                target="_blank"
              >
